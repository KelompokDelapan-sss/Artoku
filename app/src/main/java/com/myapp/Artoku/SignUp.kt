...
import com.myapp.Artoku.databinding.ActivitySignUpBinding
                    ...
                    if (pass == confirmPass){
                        ...
                        firebaseAuth.createUserWithEmailAndPassword(email, pass).addOnCompleteListener {
                            if (it.isSuccessful){ //if the sign up succesful then change activity to main activity
                                ...
                                Toast.makeText(this, "Daftar Sukses bre", Toast.LENGTH_LONG).show()
                        ...
                        Toast.makeText(this, "ID password tidak sesuai", Toast.LENGTH_LONG).show()
                    }
                }else{
                    Toast.makeText(this, "Kolom kosong tidak diperbolehkan", Toast.LENGTH_LONG).show()
                }
            }else{
                Toast.makeText(this, "Tidak valid atau Email kosong", Toast.LENGTH_LONG).show()
            }
        }
