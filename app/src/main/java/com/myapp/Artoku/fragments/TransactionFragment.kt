...
class TransactionFragment : Fragment() {
    ...
    private var selectedType: String = "Semua Tipe"
    private var selectedTimeSpan: String = "Semua Waktu"
    ...
    private fun getTransactionData() {
        ...
        query.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()){
                    when (selectedType) {
                        "Semua Tipe" -> { //all option selected
                        ...
                        "Pengeluaran" -> { //expense option selected
                            for (transactionSnap in snapshot.children){
                                val transactionData = transactionSnap.getValue(TransactionModel::class.java) //reference data class
                    ...
                    if (transactionList.isEmpty()){ //if there is no data being displayed
                        ...
                        tvVisibilityNoData.text = "Tidak ada $selectedType data $selectedTimeSpan"
                    }else{
