package com.myapp.Artoku.fragments
...
import com.myapp.Artoku.*
import com.myapp.Artoku.R
...
class AccountFragment : Fragment() {
        ...
        user?.let {
            ...
            if (user!!.isEmailVerified){ //check if user email already verified
                ...
                verified.setOnClickListener {
                    Toast.makeText(this@AccountFragment.activity, "Akunmu Terverifikasi!", Toast.LENGTH_LONG).show()
                }
            }else{
                ...
                notVerified.setOnClickListener {
                    user?.sendEmailVerification()?.addOnCompleteListener {
                        if (it.isSuccessful){
                            Toast.makeText(this@AccountFragment.activity, "Cek Emailmu! (Including Spam)", Toast.LENGTH_LONG).show()
                        }else{
    ...
    private fun showAllTimeRecap() {
        ...
        // Menghitung netAmount
        val netAmount = allTimeIncome - allTimeExpense

        // Menggunakan NumberFormat untuk memformat angka
        val formattedNetAmount = formatNumber(netAmount)  // Menggunakan format untuk netAmount
        val formattedExpense = formatNumber(allTimeExpense)  // Menggunakan format untuk allTimeExpense
        val formattedIncome = formatNumber(allTimeIncome)  // Menggunakan format untuk allTimeIncome

        // Menampilkan hasil yang sudah diformat
        tvNetAmount.text = formattedNetAmount  // Menampilkan hasil untuk netAmount
        tvAmountExpense.text = formattedExpense
        tvAmountIncome.text = formattedIncome
    }


    private fun formatNumber(number: Double): String {
        // Menggunakan NumberFormat dengan locale Indonesia untuk format yang sesuai
    ...
    private fun setupBarChart() {
        ...
        val netAmountRange = amountIncome - amountExpense
        val formattedNetAmountRange = formatNumber(netAmountRange)
        netAmountRangeDate.text = formattedNetAmountRange
        ...
        barDataSet.setColors(
            ...
            resources.getColor(R.color.biru)
        )
